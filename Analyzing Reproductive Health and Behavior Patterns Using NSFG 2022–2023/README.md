...
- Perform statistical analyses using variables of choice: Poisson regression (with assumption checks), Contingency tables (with mosaic plots), ordinal logistic regression, multinomial logistic regression, and multiple tests. 
